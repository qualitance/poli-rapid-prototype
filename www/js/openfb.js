/**
 * Created by bogdan.raduta on 2/28/15.
 */
angular.module('openfb', [])
  .factory('OpenFB', function ($rootScope, $q, $window, $http) {
    ...
    function api(obj) {
      ...
      if (obj.path.substring(0, 26) !== 'https://graph.facebook.com') {
        obj.path = 'https://graph.facebook.com' + obj.path;
      }

      return $http({method: method, url: obj.path, params: params})
